...
//console.log(cartContent, emptyCartMessage, purchaseCompleteMessage, emptyCartButton, completePurchaseButton);
...
async function handleCartAction(action, messageElement) {
    try {
      ...
      const response = await fetch(`/views/carts/${action}`, options);
